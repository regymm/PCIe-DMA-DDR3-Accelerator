...
<p>Moreover, additional feature is provided to users who don't prefer to rely on AI. In the same path: <code>SSTorytime/generated_md/</code>, you can find a file called <code>your_chapter_name_direct_Interpretation.md</code> This file contains all your N4L notes in human readable text i.e. with direct replacement of N4L arrows with their meaning. This should allow you to inspect your notes how they look like in human-readable text and also to evaluate the generated markdown from the LLM</p>
